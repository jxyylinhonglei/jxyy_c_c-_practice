...
//			for (j = 0; j < N; j++) {
//				if (flag[j] != 0 && dist[index]!=INF&&G[index][j]!=INF&& dist[j] > dist[index] + G[index][j]) {//松弛操作
...
//void Print() {
//	for (int i = 0; i < N; i++) {
//		printf("%d点到u点的最短距离为%d\n",i+1,dist[i]);
//		_print(i);
//		printf("\n");
//	}
//}
//int main() {
//	int tmp[5][5] = { {0,2,5,INF,INF},{INF,0,2,6,INF},{INF,INF,0,7,1},{INF,INF,2,0,4},{INF,INF,INF,INF,0} };
//	for (int i = 0; i < 5; i++) {
//		for (int j = 0; j < 5; j++) {
//			G[i][j] = tmp[i][j];
//		}
